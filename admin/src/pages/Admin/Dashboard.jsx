      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <div>
            ...
            <p className="text-[#0d9488] mt-1 font-medium">
              Welcome to HealthCare Hub
            </p>
          </div>
          {/* <div className="flex gap-3">
            <button className="px-5 py-2.5 bg-[#0d9488] text-white rounded-xl hover:bg-[#0c7a71] transition-colors flex items-center gap-2 shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <h2 className="text-xl font-bold text-[#0d9488] mb-6 flex items-center">
              <FaStethoscope className="mr-2 text-[#0d9488]" />
            ...
            <div className="space-y-4">
              {performanceData?.doctorPerformance?.map((doctor, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-4 hover:bg-teal-50 rounded-xl border border-gray-100 transition-colors"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-r from-teal-300 to-[#0d948899] flex items-center justify-center text-white font-bold shadow-inner">
                    ...
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        <div className="flex gap-2">
                          <span className="text-xs bg-[#0d948833] text-[#0d9488] px-2 py-1 rounded-full font-medium">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500">
                      {doctor.appointments || 0} consultations
                    </p>
                  </div>
                </div>
              ))}
            ...
            <button
              className="w-full mt-6 py-2.5 text-[#0d9488] font-medium bg-teal-50 hover:bg-[#0d948833] rounded-xl transition-colors"
                  ...
                  {recentActivities && recentActivities.length > 0 ? (
                    recentActivities.map((activity, index) => (
                      <li key={index} className="relative pl-10">
                        <div
                          className={`absolute left-3 -translate-x-1/2 w-8 h-8 rounded-full flex items-center justify-center ${
                            activity.type === "New Doctor"
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-blue-50 to-teal-50">
              ...
              <button
                className="text-[#0d9488] text-sm font-medium bg-white px-4 py-1.5 rounded-lg shadow-sm hover:shadow-md transition-all"
