  ...
  const exportData = () => {
    const csvContent =
      ...
      appointments
        .map(
          (appointment) =>
            `${appointment.userData.name},${appointment.slotDate},${appointment.slotTime},${appointment.docData.name},${appointment.amount}`
        )
        .join("\n");
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="flex gap-3">
            ...
            <button
              className="px-5 py-2.5 bg-[#0d9f92] text-white rounded-xl hover:bg-[#0b8076] transition-colors flex items-center gap-2 shadow-sm"
              onClick={exportData}
            >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-teal-50 to-[#0d948833]">
            <h2 className="text-xl font-bold text-[#0d9488] flex items-center">
              <FaNotesMedical className="mr-2 text-[#0d9f92]" />
              Patient Consultations
            </h2>
            <span className="text-xs font-medium text-[#0d9f92] bg-blue-50 px-3 py-1 rounded-full">
              {appointments.length} Total
            </span>
          </div>

          {/* Desktop View Header */}
          <div className="hidden sm:grid grid-cols-[minmax(40px,0.5fr)_3fr_minmax(60px,1fr)_3fr_3fr_minmax(100px,1fr)_100px] items-center py-4 px-6 bg-gradient-to-r from-teal-50 to-[#0d948833] backdrop-blur text-[#0d9488] text-sm font-semibold uppercase tracking-wide border-b border-blue-100">
            <span>#</span>
            <span>Patient</span>
            <span>Age</span>
            <span>Date & Time</span>
          ...
          <div className="relative max-h-[70vh] overflow-y-auto">
            {appointments.map((item, index) => (
              <div
                key={item._id}
                className="group border-b border-gray-100 hover:bg-teal-50 transition-colors duration-200"
              >
                {/* Desktop View */}
                <div className="hidden sm:grid grid-cols-[minmax(40px,0.5fr)_3fr_minmax(60px,1fr)_3fr_3fr_minmax(100px,1fr)_100px] items-center px-6 py-4 text-gray-700">
                  ...
                  <div className="flex items-center gap-3 truncate">
                    {item.userData.image ? (
                      ...
                      <div className="w-10 h-10 rounded-full bg-[#0d948833] flex items-center justify-center text-blue-700 font-bold">
                  ...
                  <div className="flex justify-center">
                    {item.cancelled ? (
                      ...
                      <span className="px-3 py-1 bg-[#0d948833] text-[#0d9488] text-xs font-medium rounded-lg">
                        Scheduled
                      </span>
                    )}
                  </div>
                ...
                <div className="sm:hidden flex items-center p-3 border-b border-gray-100">
                  <div className="w-8 h-8 rounded-full bg-[#0d948833] flex items-center justify-center text-blue-700 font-bold text-xs mr-3">
                    {getNameInitial(item.userData.name)}
                  </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6 space-y-6">
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-bold text-[#0d9488]">
            ...
            <div>
              <p className="text-gray-600 mb-4">
                This will generate appointment slots from 9 AM to 5 PM for the
                next 7 days (excluding Fridays). Each appointment is 1 hour
                long.
              </p>
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                className={`px-4 py-2 bg-[#0d9f92] text-white rounded-lg ${
