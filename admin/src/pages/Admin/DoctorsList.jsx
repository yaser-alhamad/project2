    ...
    <div className="m-5 max-h-[90vh] overflow-y-scroll">
      ...
      <div className="w-full flex flex-wrap gap-4 pt-5 gap-y-6">
        {doctors.map((item, index) => (
          ...
          >
            <img
              className="bg-[#0d948833] group-hover:bg-primary transition-all duration-500"
              src={item.image}
              alt=""
            />
            <div className="p-4">
              ...
              <div className="flex flex-col gap-1 mt-2">
                <span className="text-[#5C5C5C] text-sm font-medium ">
                  Total Appointments: {item.PerformanceData?.total_appointments}{" "}
                </span>
                <span className="text-[#5C5C5C] text-sm font-medium  ">
                  Total Revenue: ${item.PerformanceData?.total_revenue}
                </span>
                <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full font-medium">
                  {" "}
                  {item.PerformanceData?.completion_rate}% efficacy{" "}
                </span>
                <span className="text-xs bg-[#0d948833] text-[#0d9488] px-2 py-1 rounded-full font-medium">
                  {" "}
                  {item.PerformanceData?.patient_count} patients
                </span>
              </div>
        ...
        <div
          ...
          className="border border-dashed border-[#C9D8FF] rounded-xl max-w-56 min-w-56 min-h-[300px] flex flex-col items-center justify-center cursor-pointer hover:bg-[#0d948833] transition-all duration-300"
        >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center ">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-4xl space-y-4">
            ...
            <form onSubmit={onSubmitHandler} className="m-5 w-full">
              <span className="font-semibold text-2xl  text-center justify-center ">
                Add Doctor
              </span>
