    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("contact.address.line1", e.target.value)
                  }
                  className="w-full p-2 border rounded-md"
                />
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("contact.address.line2", e.target.value)
                  }
          ...
          {/* Medications Section */}
          <SectionCard
            icon={<ClipboardCheckIcon className="w-6 h-6 text-purple-500" />}
            title="Medications"
          >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        value={visit.reason}
                        onChange={(e) =>
                          handleVisitChange(index, "reason", e.target.value)
                        }
                        className="w-full p-2 border rounded-md"
                      />
                    </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleVisitChange(
                              index,
                              "vital_signs.blood_glucose_mg_dl",
                              e.target.value
                            )
                          }
                          className="w-full p-2 border rounded-md"
