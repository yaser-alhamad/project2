    ...
    <div className="bg-[#F8F9FD]">
      ...
      <div className="flex items-start">
        ...
        <Routes>
          <Route
            path={"/"}
            element={aToken ? <Dashboard /> : <NewAppointments />}
          />
          ...
          <Route
            path="/admin/patientrecord_admin/:id"
            element={<PatientRecord />}
          />
          <Route path="/doctor/patients" element={<Patients />} />
          <Route
            path="/doctor/patientrecord_doctor/:id"
            element={<PatientRecord_Doctor />}
          />
          <Route
            path="/doctor/new-appointments"
            element={<NewAppointments />}
          />
          <Route
            path="/doctor/addnewpatientrecord/:id"
            element={<AddNewPatientRecord />}
          />
          <Route path="/admin/manage-slots" element={<MangeSolts />} />
          <Route
            path="/doctor/manage-slots_doctor"
            element={<MangeSolts_Doctor />}
          />
        </Routes>
      </div>
    </div>
